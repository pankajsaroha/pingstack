...
const categories = [
  {
    ...
    icon: Zap,
    articles: [
      { title: 'Manual Connectivity Guide', slug: 'manual-connectivity' },
      { title: 'Testing your implementation', slug: 'testing-implementation' },
      { title: 'Plan limits overview', slug: 'plan-limits' }
    ]
  },
  {
    title: 'Messaging API',
    icon: Book,
    articles: [
      { title: 'Sending your first campaign', slug: 'first-campaign' },
      { title: 'Template variables guide', slug: 'template-variables' },
      { title: 'Handling delivery status', slug: 'delivery-status' }
    ]
  },
  {
    ...
    articles: [
      ...
      { title: 'Data Encryption policy', slug: 'data-encryption' }
    ]
  }
];
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-20">
      ...
      <div className="mt-20 p-12 bg-gray-900 rounded-[3rem] text-center relative overflow-hidden group">
        ...
        <Link href="/contact" className="mt-10 inline-block px-10 py-4 bg-blue-600 text-white rounded-2xl font-black text-sm hover:bg-blue-500 transition-all shadow-xl active:scale-95 transform translate-y-0 hover:-translate-y-1 relative z-10">
          Contact Support
        </Link>
      </div>
    </div>
