...
import MetaCostCard from './_components/MetaCostCard';
import PlanLimitsCard from './_components/PlanLimitsCard';
import PerformanceChart from './_components/PerformanceChart';
import ConnectionManager from './_components/ConnectionManager';
import BillingModal from './_components/BillingModal';

// Lazy-load heavy/conditionally-rendered sections
const OnboardingWizard = lazy(() => import('./_components/OnboardingWizard'));
const DeveloperPortal = lazy(() => import('./_components/DeveloperPortal'));
