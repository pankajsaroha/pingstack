...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden selection:bg-blue-100">
      ...
      <div className="max-w-md w-full space-y-8 p-10 bg-white/80 backdrop-blur-xl border border-white/60 rounded-[2rem] shadow-[0_8px_40px_rgb(0,0,0,0.04)] relative z-50 transition-all">
        ...
        <div>
          <h2 className="text-center text-3xl font-extrabold text-gray-900 tracking-tight">Join PingStack</h2>
          <p className="mt-2 text-center text-sm text-gray-500 font-medium">Get started with your free account.</p>
        </div>
